...
<script src="<?= base_url("assets/js/iletisim.js"); ?>" type="text/javascript" charset="utf-8" async="" defer=""></script>
<form class="iletisim transparan col-lg-5 col-md-6 col-sm-8 col-12 m-auto p-2">
    ...
    <div class="form-group mt-1 m-auto py-1" data-nosnippet>
        <div class="g-recaptcha" style="margin-top:20px;" data-callback="recaptchaOnaylandi" data-expired-callback="recaptchaSureBitti" data-sitekey="<?= $recaptcha_site_key; ?>"></div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-danger text-white">
            ...
            <div id="mesajBasarisizAciklama2" class="modal-body bg-light text-dark text-start">
                Mesajınız gönderilemedi lütfen daha sonra tekrar deneyin ya da <a class="alticizgilihv text-decoration-none" href="mailto:iletisim@ozayakcan.com.tr">iletisim@ozayakcan.com.tr</a> adresinden bana ulaşın.
